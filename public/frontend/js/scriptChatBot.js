...
function setUserResponse(val) {
    var UserResponse =
        ...
        "/public/frontend/images/userAvatar.jpg" +
        '><p class="userMsg">' +
        val +
...
function setBotResponse(val) {
    setTimeout(function () {
        if (val.length < 1) {
            ...
            msg =
                "Tôi không thể hiểu được bạn muốn nói gì. Hãy thử một cái gì đó khác!";

            var BotResponse =
                '<img class="botAvatar" src="/public/frontend/images/bot.jpg"><p class="botMsg">' +
                msg +
                '</p><div class="clearfix"></div>';
